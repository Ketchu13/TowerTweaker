...
Public Class Form1
    ...
    Dim heatbed_temps_linked As Boolean = True
        ...
        Try
            ...
            If File.Exists(filepath_src) Then
                ...
                ElseIf src_gcode.Contains("generated by Slic3r") Then
                    slicer_name = "Slic3r - Not yet supported"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            If src_gcode Is Nothing Then
                ...
                Exit Sub
            Else
                new_gcode = Utils_.ReplaceSettings(hotend_temp,
                                                   fan_speeds,
                                                   src_gcode,
                                                   slicer_name,
                                                   fans_speed_linked,
    ...
    Private Sub TextBox27_TextChanged(sender As Object, e As EventArgs) Handles TextBox27.TextChanged, TextBox28.TextChanged, TextBox29.TextChanged, TextBox30.TextChanged, TextBox31.TextChanged, TextBox32.TextChanged
        If sender.name.ToString.Length > 0 And Not heatbed_temp Is Nothing Then
            ...
            If fans_speed_linked Then
                ...
                heatbed_temp(0) = Math.Min(100, Val(sender.text))
                heatbed_temp_tmp(0) = Math.Min(100, Val(sender.text))
            Else
                Select Case sender.name
                    Case "TextBox27"
                        heatbed_temp(0) = Math.Min(100, Val(sender.text))
                        heatbed_temp_tmp(0) = Math.Min(100, Val(sender.text))
                    Case "TextBox28"
                        heatbed_temp(1) = Math.Min(100, Val(sender.text))
                        heatbed_temp_tmp(1) = Math.Min(100, Val(sender.text))
                    Case "TextBox29"
                        heatbed_temp(2) = Math.Min(100, Val(sender.text))
                        heatbed_temp_tmp(2) = Math.Min(100, Val(sender.text))
                    Case "TextBox30"
                        heatbed_temp(3) = Math.Min(100, Val(sender.text))
                        heatbed_temp_tmp(3) = Math.Min(100, Val(sender.text))
                    Case "TextBox31"
                        heatbed_temp(4) = Math.Min(100, Val(sender.text))
                        heatbed_temp_tmp(4) = Math.Min(100, Val(sender.text))
                    Case "TextBox32"
                        heatbed_temp(5) = Math.Min(100, Val(sender.text))
                        heatbed_temp_tmp(5) = Math.Min(100, Val(sender.text))
                End Select
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged, TextBox4.TextChanged, TextBox5.TextChanged, TextBox6.TextChanged, TextBox7.TextChanged, TextBox8.TextChanged
        ...
        If sender.name.ToString.Length > 0 And Not hotend_temp Is Nothing Then
            ...
            If hotend_temps_linked Then
                ...
                hotend_temp(0) = Math.Max(100, Val(sender.text))
                hotend_temp_tmp(0) = Math.Max(100, Val(sender.text))
            Else
                Select Case sender.name
                    Case "TextBox3"
                        hotend_temp(0) = Math.Min(300, Val(sender.text))
                        hotend_temp_tmp(0) = Math.Min(300, Val(sender.text))
                    Case "TextBox4"
